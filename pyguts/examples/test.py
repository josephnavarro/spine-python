...
if __name__ == '__main__':
    ...
    atlas = spine.Atlas(file='./data/c010_00.atlas')
    skeletonJson = spine.SkeletonJson(spine.AtlasAttachmentLoader(atlas))
    skeletonData = skeletonJson.readSkeletonDataFile('./data/c010_00.json')
    walkAnimation = skeletonData.findAnimation('action')
